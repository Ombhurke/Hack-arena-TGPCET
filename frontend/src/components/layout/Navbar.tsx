          ...
          <div className="container mx-auto px-4 h-16 flex items-center justify-between gap-3">
            ...
            <Link to="/" className="flex items-center gap-3 min-w-[180px] group">
              ...
              <div className="leading-tight">
                <div className="font-black font-heading text-xl tracking-tighter bg-clip-text text-transparent bg-gradient-to-r from-blue-700 via-blue-500 to-teal-400 dark:from-blue-400 dark:via-cyan-300 dark:to-teal-200">
                  HEALTH<span className="opacity-50 font-normal">CORE</span>
                </div>
                <div className="text-[9px] uppercase tracking-[0.2em] font-black text-primary/70 hidden sm:block">
                  AI-Powered Clinical Trust
                </div>
              </div>
            </Link>
